...
stata -b code/estimate_variance.do
...
# Table 5 ✔️
stata -b code/entry_ivs_part1.do

# Figure 1 ✔️
python code/vcov_main_part3.py

# Figure 2 and A3, Tables A4 and A5 ✔️
stata -b code/estimate_ovb.do

# Figures 3-4, A5 ✔️
stata -b code/estimate_heterog_variance.do 
...
# Figure A4
stata -b code/estimate_variance_robustness.do
python code/vcov_robustness.py

# Tables A1 and A12 ✔️
stata -b code/teacher_chars.do

# Table A2-A3 ✔️
stata -b code/regression_version.do

# Tables A6 and A7 ✔️
stata -b code/entry_ivs_part2.do
stata -b code/entry_ivs_part3.do
...
stata -b code/vcov_hetero_subgroups_table.do

# Calculations cited in-text only ✔️
stata -b code/covariate_correlation_part1.do
